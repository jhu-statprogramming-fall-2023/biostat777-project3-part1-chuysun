...
tornados%>%
  ...
  labs(title = "Total injuries in tornados in every 24 years",
       subtitle = "Between 1950-1974, there were a lot of injuries, and 2000-2024 had the lowest injuries. There is a decreasing trend over time.", x="States", y="average tornados magnitude", caption = "Chuyi Sun")
